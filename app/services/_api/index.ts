import { TGoodToKnow } from "../_components/GoodToKnow";
import { THowItWork } from "../_components/HowItWork";
import { TService } from "../_components/Service";

export const servicesApi: TService[] = [
  {
...
export const howItWorkApi: THowItWork[] = [
  {
    title: "application",
...
export const goodToKnowApi: TGoodToKnow[] = [
  {
