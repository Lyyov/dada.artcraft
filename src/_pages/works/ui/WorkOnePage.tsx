...
export const WorkOnePage = ({ images, description, name, info }: IWork) => {
  ...
  return (
    <div className="container one-work-container">
      ...
      <section className="section pb-4 md:pb-10">
        <h3 className="title-primary text-foreground-secondary md:mt-12 mb-5">
          {name}
        </h3>
      ...
      <section className="section mx-auto mb-0 md:mb-12">
        {description.map((paragraph, index) => (
          <p
            key={index}
            className="paragraph text-foreground-secondary paragraph-secondary-leading"
          >
            {paragraph}
          </p>
        ))}
