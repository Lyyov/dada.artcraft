...
const Contact = () => {
  ...
  handleChangeFirstname = (e) => setData({...data, firstname: e.target.value}),
  handleChangeLastname = (e) => setData({...data, lastname: e.target.value}),
    ...
    <div className="contact" id="contact">
      <div className="container">
        ...
        <div className="row contact__row">
            ...
            <div className="row">
              <div className="col-md-6">
                <div className={data.firstname !== "" ? `input-container focused` : `input-container`}>
                  <input onChange={handleChangeFirstname} className="input-container__input" type="text" name="firstname" id="firstname" />
              ...
              <div className="col-md-6">
                <div className={data.lastname !== "" ? `input-container focused` : `input-container`}>
                  <input onChange={handleChangeLastname} className="input-container__input" type="text" name="lastname" id="lastname" />
                  <label className="input-container__label" for="lastname">
                    last name
                  </label>
                </div>
              </div>
              ...
              <div className="col-sm-12">
                <div className={data.message !== "" ? `input-container focused` : `input-container`}>
                  <textarea onChange={handleChangeMessage} rows="5" className="input-container__input" placeholder="Type the message you wish to send" name="message" id="message" />
          ...
          <div className="col-lg-5 col-md-6">
            <h5 className="contact__subtitle right">
            You can find us at:
            </h5>
            <p className="contact__text">
            Our motivation helps to craft meaningful experiences for the people around us, this mission inspires us each day and guides every aspect of what we do.
            </p>
