      ...
      <div className="project__container">
        ...
        <Section>
          <div className="saula__container-flex">
            ...
            <ImgContainer zoomHandler={zoomHandler} src={`${process.env.PUBLIC_URL}${images[2].src}`} id={images[2].id} alt={images[2].alt} />
          </div>
        </Section>
        <Section className="project__section-pad0">
            <p className="project__text saula__text text">
        ...
        </Section>
        {
          images.slice(3, 6).map(item => (
            <Section key={item.id}>
              <ImgContainer zoomHandler={zoomHandler} src={`${process.env.PUBLIC_URL}${item.src}`}
              id={item.id} alt={item.alt}/>
            </Section>
          ))
        }
        <Section>
          <div className="saula__container-flex">
            <ImgContainer zoomHandler={zoomHandler} src={`${process.env.PUBLIC_URL}${images[6].src}`} id={images[6].id} alt={images[6].alt} />
            <ImgContainer zoomHandler={zoomHandler} src={`${process.env.PUBLIC_URL}${images[7].src}`} id={images[7].id} alt={images[7].alt} />
          </div>
        </Section>
        {
        ...
        <Section>
          <div className="saula__container-flex"  style={{gridTemplateColumns: "1.4fr 1fr"}}>
            <ImgContainer zoomHandler={zoomHandler} src={`${process.env.PUBLIC_URL}${images[11].src}`} id={images[11].id} alt={images[11].alt} />
            <ImgContainer zoomHandler={zoomHandler} src={`${process.env.PUBLIC_URL}${images[12].src}`} id={images[12].id} alt={images[12].alt} />
          </div>
        </Section>
        <Section>
          <ImgContainer zoomHandler={zoomHandler} src={`${process.env.PUBLIC_URL}${images[13].src}`} id={images[13].id} alt={images[13].alt} />
        </Section>
        <Section>
          <div className="saula__container-flex"  style={{gridTemplateColumns: "1fr 1.1fr"}}>
            <ImgContainer zoomHandler={zoomHandler} src={`${process.env.PUBLIC_URL}${images[14].src}`} id={images[14].id} alt={images[14].alt} />
            <ImgContainer zoomHandler={zoomHandler} src={`${process.env.PUBLIC_URL}${images[15].src}`} id={images[15].id} alt={images[15].alt} />
          </div>
        </Section>
        {
